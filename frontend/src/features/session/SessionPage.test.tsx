...
beforeEach(()=>{
  useSessionStore.setState({hydrate:vi.fn().mockResolvedValue(undefined),room:baseRoom,language:'python',currentSlot:'A',isPartnerOnline:true,isLoading:false,error:null})
